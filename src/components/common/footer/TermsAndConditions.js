  ...
  return (
    <div className="terms-container">
      ...
      <section>
        ...
        <p>Welcome to GrowAgro! These Terms and Conditions govern your use of our platform, services, and products. By accessing or using GrowAgro's services, you agree to be bound by these terms.</p>
      </section>
